...
The analysis strongly supports the hypothesis that transcriptomic profiles at Day 6 reflect significant changes in stress response and metabolic pathways. The upregulation of genes related to immune responses (FOSB, CHGA) and metabolic shifts (CYP1A1, SCD) aligns with previous literature, suggesting an adaptation to ex vivo conditions (Roussos et al., 2011; Walker et al., 2018; Giese et al., 2019). Furthermore, enrichment analysis highlights potential mechanisms related to tumor survival and drug resistance, particularly through the IL-17 signaling pathway, which has been implicated in inflammation-driven cancer progression (Kawasaki & Yokomizo, 2018; Zhang et al., 2021).
...
7.  Kawasaki, Y., & Yokomizo, T. (2018). The role of leukotriene B4 receptors in inflammatory diseases. Allergology International, 67(2), 186–190. <https://doi.org/10.1016/j.alit.2017.11.002>

8.  Zhang, X., Zhang, Y., He, Z., Yin, K., Li, B., Zhang, L., & Xu, Y. (2021). IL-17 promotes ovarian cancer progression by upregulating PD-L1 expression via STAT3 pathway activation. Frontiers in Oncology, 11, 719312. <https://doi.org/10.3389/fonc.2021.719312>
